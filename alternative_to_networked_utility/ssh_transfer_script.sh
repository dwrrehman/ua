...
ssh dwrr-mini4.local "./root/commands_executed_on_mini.sh"
ssh dwrr-mini5.local "./root/commands_executed_on_mini.sh"
ssh dwrr-mini6.local "./root/commands_executed_on_mini.sh"
ssh dwrr-mini7.local "./root/commands_executed_on_mini.sh"
ssh dwrr-mini8.local "./root/commands_executed_on_mini.sh"
ssh dwrr-mini9.local "./root/commands_executed_on_mini.sh"
