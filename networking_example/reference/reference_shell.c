...
static nat wrap_width = 45;
static nat max_row_count = 10;
...
int main(void) {
	...
	array[0][x++] = newline;
	array[0][x++] = tab;
	array[0][x++] = read_output;
	array[0][x++] = submit;
	array[0][x++] = finishjob;
	array[0][x++] = sendeof;
	array[0][x++] = jump_to_end;
	array[0][x++] = cycle_reset;
	counts[0] = x;
	...
	array[1][x++] = ins_dot;
	array[1][x++] = ins_comma;
	array[1][x++] = ins_open_paren;
	array[1][x++]= ins_close_paren;
	array[1][x++] = newjob;
	array[1][x++] = closejob;
	array[1][x++] = nextjob;
	counts[1] = x;
	...
	array[2][x++] = ins_h;
	array[2][x++] = ins_d;
	array[2][x++] = ins_apostrophe;
	array[2][x++] = ins_question_mark;
	array[2][x++] = ins_open_square;
	array[2][x++]= ins_close_square;
	array[2][x++]= oc_left;
	array[2][x++]= oc_right;
	array[2][x++]= oc_left10;
	array[2][x++]= oc_right10;
	array[2][x++]= oc_copy;
	array[2][x++]= oc_paste;
	array[2][x++]= oc_anchor;
	counts[2] = x;
	...
	array[3][x++] = ins_f;
	array[3][x++] = ins_quote;
	array[3][x++] = ins_exclamation_mark;
	array[3][x++] = ins_open_brace;
	array[3][x++]= ins_close_brace;
	array[3][x++]= caps;
	counts[3] = x;
	...
	array[4][x++] = ins_p;
	array[4][x++] = ins_b;
	array[4][x++] = ins_hyphen;
	array[4][x++] = ins_colon;
	array[4][x++] = ins_less;
	array[4][x++]= ins_greater;
	counts[4] = x;
	...
	array[5][x++] = ins_j;
	array[5][x++] = ins_z;
	array[5][x++] = ins_underscore;
	array[5][x++] = ins_semicolon;
	array[5][x++] = ins_ampersand;
	array[5][x++]= ins_vertical;
	counts[5] = x;
	...
	array[6][x++] = ins_3;
	array[6][x++] = ins_4;
	array[6][x++] = ins_equals;
	array[6][x++] = ins_plus;
	array[6][x++] = ins_star;
	array[6][x++]= ins_pound;
	array[6][x++]= ins_at_sign;
	array[6][x++]= incr_mrc;
	array[6][x++]= decr_mrc;
	counts[6] = x;
	...
	array[7][x++] = ins_9;
	array[7][x++] = ins_slash;
	array[7][x++] = ins_percent;
	array[7][x++] = ins_caret;
	array[7][x++] = ins_backslash;
	array[7][x++]= ins_grave;
	array[7][x++]= ins_tilde;
	array[7][x++]= incr_wrap;
	array[7][x++]= decr_wrap;
	...
	wrap_width = window.ws_col - 4;
	max_row_count = window.ws_row - 8;
...
loop:;	
	...
	printf("\n[%llu:%llu]:%c: %s\n", job_pointer, job_count, not caps_lock ? 'l' : 'C', message);
	if (job_count) {
 ...
 // c == ',' or or c == cycle1_key or c == cycle1_key_alt
// c == '.' or  or c == select_key or c == select_key_alt
