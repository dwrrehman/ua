...
void print_description_for_command(const char* c) {
    ...
    else if (strings_equal(c, "threshold")) printf("\n\t threshold <thr> ::\n\n\t\t search over the unknown values in the current hgrid specified by a file, and record which z values have alifetime length above a given threshold.\n");
