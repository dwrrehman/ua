...
int main(int argc, const char * argv[]) {
    ...
    if (argc < 8) {
        printf("usage: ./program m n t delay nd np break \n\n"
               ...
               "\t- delay (nat0) : CA lifetimes found to be below this threshold will not be reported. \n" 
               ...
               "\t- Should Break (bool) : whether you want to halt when you reach a redundant state.\n"
               "\n");
        exit(1);
    }
