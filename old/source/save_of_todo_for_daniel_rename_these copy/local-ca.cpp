...
int main(int argc, const char * argv[]) {
    ...
    nat g[l], h[l], ns[nc], result[Hc], states[H];
    ...
    for (nat z = 0; z < Z; z++) {
        ...
        if (z % 10000 == 0) printf("\r [ k_z = %lu  /  %lu ]", z, Z);
    
        reduce(result, z, m, Hc); 
        memset(g, 0, sizeof g);
        g[0] = 1;
        nat state_count = 0;
